# Kiosk System Setup Script (Wayland)

[!WARNING] Wayland support is currently under development and may not be fully functional. It is strongly recommended to use the "Release" branch until development on Wayland support is complete.
...
The script will complete the setup, automatically logging in as the kiosk user, starting the X server, and launching the selected browser in kiosk mode. Once the script finishes, the system will reboot. After the reboot, the kiosk interface will start automatically.
